...
void UMS::ATI(string name,string opt)
{
...
{				 system("cls");
...

			{
				...
				case 4: deleteTask();//facultyLogin() Will Be Here; //choice 2
						break; //have to break
				case 5: mainMenu();//mainMenu Calling Will Be Here
						break; //have to break
...
inline void UMS::mainMenu()//Defination of mainMenu Function Declared In Class UMS Public Section
 {	system("cls");
	...
	std::cout<<"2- Faculty Login"<<endl;//Statement
	userInput();
}
